...
Page({
  ...
  async handleSubmit() {
    ...
    const descriptor = {
      ...
      tel: { required: true, pattern: /^1(3[0-9]|4[01456879]|5[0-35-9]|6[2567]|7[0-8]|8[0-9]|9[0-35-9])\d{8}$/, message: '请填写正确的联系方式' }
    };
    const validator = new Schema(descriptor);
    await validator.validate(this.data.form)
      .catch(({ errors }) => {
    ...
    wx.$history.redirectTo({ url: '/pagesExtra/complaints/success/success' });
  },
